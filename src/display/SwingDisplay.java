...
public class SwingDisplay extends JPanel {
    ...
    private void drawConnections(Graphics2D g2) {
        ...
        for (Connection c : graph.getConnections()) {
            ...
            // Incident : connexion bloquee en rouge
    ...
    private void drawStations(Graphics2D g2) {
        ...
        for (Station s : graph.getStations()) {
            ...
            // Incident : gare fermee, bordure rouge epaisse
            if (s.isClosed()) {
                g2.setStroke(new BasicStroke(2.5f));
    ...
    private void drawVehicles(Graphics2D g2) {
        ...
        for (Vehicle v : vehicles) {
            ...
            // Incident : vehicule HS, contour rouge epais
    ...
    /**
     * Position du passager tracké sur la carte :
     * - ON_BOARD  → même position interpolée que son véhicule
     * - WAITING   → centre de sa station courante
     * - ARRIVED   → centre de sa station de destination
     */
