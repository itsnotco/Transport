...
public class SwingDisplay extends JPanel implements SimulationObserver {
    ...
    /**
     * Reçoit les notifications du VehicleScheduler (pattern Observer).
     * Enregistre le mouvement dans le journal d'activité puis se redessine.
     */
    @Override
    ...
    /**
     * Branche l'action a executer a chaque appui sur ENTREE dans la fenetre,
     * et active l'ecoute clavier. Q quitte l'application.
     */
    ...
    private void drawDashboard(Graphics2D g2) {
        ...
        // ---- ACTIVITE (journal alimenté par l'Observer) ----
        y += 32; g2.setColor(TEXT);
        g2.setFont(new Font("SansSerif", Font.BOLD, 13));
        g2.drawString("ACTIVITE RECENTE", x, y);
        g2.setFont(new Font("SansSerif", Font.PLAIN, 11));
        if (recentActivity.isEmpty()) {
            y += 18; g2.setColor(new Color(150, 155, 165));
        ...
        y += 18;
        g2.setColor(TRACKED_C); g2.fillOval(x, y - 10, 12, 12);
        g2.setColor(TEXT); g2.drawString("Suivi", x + 18, y);
