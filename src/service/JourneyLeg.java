/*
 * Représente un tronçon atomique d'un itinéraire : un seul véhicule,
 * une station de montée, une station de descente, et les minutes de
 * montée/descente calculées par RouteService lors de la planification.
 */
package service;
