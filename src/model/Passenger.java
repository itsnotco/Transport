/*
 * Représente un passager avec son itinéraire multi-tronçons (plan).
 * Le plan est une liste de JourneyLeg calculée par RouteService.
 * legIndex pointe vers le tronçon en cours et avance à chaque correspondance réussie.
 */
package model;
...
public class Passenger {
    ...
    // Réassigne un nouveau plan et remet l'index de tronçon à zéro.
    public void setPlan(List<JourneyLeg> plan) {
        this.plan = plan;
        this.legIndex = 0;
    }

    // Retourne le tronçon actif, ou null si tous les tronçons ont été parcourus.
    ...
    // Avance au tronçon suivant lors d'une descente avec correspondance.
