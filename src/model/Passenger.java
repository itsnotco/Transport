...
public class Passenger {
    ...
    public int getLastShownArrival() {
        return lastShownArrival;
    }

    public void setLastShownArrival(int t) {
        this.lastShownArrival = t;
    }
