...
public class VehicleFactory {
    ...
    public static List<Vehicle> create(NetworkGraph graph) {
        ...
        tm1.setRoute(buildRoute(gareCentrale, republique, victorHugo, prefecture, jardinPublic, parcSud,
                egliseNeuve, vieuxBourg, lesAcacias, innovation, technopole, universite, gareCentrale));
        vehicles.add(tm1);
        ...
        Tram tm5 = new Tram("TM-5", 40);
        tm5.setRoute(buildRoute(lesAcacias, vieuxBourg, egliseNeuve, parcSud, jardinPublic, prefecture,
                victorHugo, republique, gareCentrale, universite, technopole, innovation, lesAcacias));
        vehicles.add(tm5);
