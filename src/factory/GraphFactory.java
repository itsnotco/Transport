/*
 * Construit le graphe complet du réseau de transport.
 * Définit les 20 stations avec leurs capacités et types de véhicules acceptés,
 * puis les connexions bidirectionnelles avec leurs distances respectives.
 */
package factory;
...
public class GraphFactory {
    ...
    public static NetworkGraph create() {
        ...
        // Déclaration des stations : identifiant, nom affiché, capacité max, types acceptés.
        ...
        // Ajout de toutes les stations au graphe.
        ...
        // Connexions bidirectionnelles avec distances ; la distance conditionne le temps de trajet selon la vitesse du véhicule.
        ...
        graph.addConnection(new Connection(lesAcacias, innovation, 3.0));
        graph.addConnection(new Connection(innovation, technopole, 2.0));
        graph.addConnection(new Connection(technopole, universite, 3.0));
        graph.addConnection(new Connection(universite, gareCentrale, 5.0));
        graph.addConnection(new Connection(citeAdmin, arsenal, 3.0));
